    ...
    try {
      ...
      if (isMobile && !actionTypesRegistered) {
        ...
        await onAction((notification) => {
          ...
          // Extract task IDs from notification metadata
          const taskIds = notification.notification?.metadata?.taskIds || [];
          
          if (notification.actionId === 'view-tasks') {
            console.log('View tasks action pressed for task IDs:', taskIds);
            appNavigation('/home');
          }
        });
