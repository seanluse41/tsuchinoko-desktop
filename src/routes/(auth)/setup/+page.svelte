...
<script>
    ...
    async function handleSubmit() {
        try {
            ...
            await secretManager.storeSecret('kintone_client_id', clientId);
            await secretManager.storeSecret('kintone_subdomain', subdomain);
    ...
    <Card class="max-w-4xl mx-auto w-full p-8 z-10">
        ...
        {#if authToken}
            <div class="mb-4 p-4 bg-moss_green-100 border border-moss_green-300 rounded-md">
                ...
                <P class="text-moss_green-800 mt-2 break-all">Token: {authToken}</P>
            </div>
        {/if}
        ...
        <List class="space-y-8 mb-8">
            ...
            <Li>
                <P class="font-bold">4. After registering, copy your Client ID:</P>
                <div class="mt-2">
                    <Input
                        bind:value={clientId}
        ...
        <div class="flex flex-col gap-4 items-center">
            <Button
                ...
                disabled={!subdomain || !clientId || isLoading}
