...
<main class="flex w-full p-8 relative">
    <Card class="max-w-4xl">
        <Button color="amber" onclick={backToLogin}><ArrowLeftOutline class="h-7 w-7" /></Button>
        <div
            class="flex flex-col items-center md:items-start mx-auto w-full p-4 md:p-8"
        >
            ...
            <div class="flex flex-col gap-4 items-center mt-4 mb-4">
                <div class="w-full max-w-md">
                    ...
                    <span class="text-xs text-slate-500 mt-1">
                        Please enter the ID of your TSUUCHINOKO space (1-3
                        digits)
                    </span>
                    <span class="text-xs text-slate-500 mt-1">
